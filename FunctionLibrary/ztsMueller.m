function [MEP_XCoords,MEP_YCoords]=ztsMueller(alphaGrid,betaGrid,energiesGrid,...
    CurrStartPoint1,CurrStartPoint2,CurrEndPoint1,CurrEndPoint2,varargin)
% Zero-temperature string method (ZTS) code. Outputs the MEP path.
% Adapted from http://cims.nyu.edu/~eve2/string.htm
% xx,yy,v1 are in mesh grid format.
% xa,ya,xb,yb are start and end points.
